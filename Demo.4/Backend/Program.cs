...
class Program
{
    public const string ConnectionString = @"Data Source=.\SqlExpress;Database=OnlyOnce.Demo4.Backend;Integrated Security=True";
    ...
    static async Task Start()
    {
        ...
        Console.Title = "OnlyOnce.Demo4.Backend";

        var config = new EndpointConfiguration("OnlyOnce.Demo4.Backend");
        ...
        using (var receiverDataContext = new BackendDataContext(new SqlConnection(ConnectionString), null))
        {
