...
namespace Frontend
{
    class Program
    {
        ...
        static async Task Start()
        {
            ...
            Console.Title = "OnlyOnce.Demo3.Frontend";

            var config = new EndpointConfiguration("OnlyOnce.Demo3.Frontend");
            ...
            routing.RouteToEndpoint(typeof(SubmitOrder).Assembly, "OnlyOnce.Demo3.Backend");
